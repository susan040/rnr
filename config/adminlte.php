    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Home',
            'route'  => 'admin.home',
            'icon' => 'nav-icon fas fa-home', // Home icon
            'role' => 'admin'
        ],
        ...
        [
            ...
            'icon' => 'nav-icon fas fa-users', // Users icon
            'role' => 'admin'
        ],
        ...
        [
            ...
            'icon' => 'nav-icon fas fa-car', // Vehicle icon
            'role' => 'admin'
        ],
        ...
        [
            ...
            'icon' => 'nav-icon fas fa-list', // Category icon
            'role' => 'admin'
        ],
